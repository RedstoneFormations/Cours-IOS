...
Créer une todo list avec :

- Ajout/suppression de tâches
- Persistance locale (UserDefaults)
- Interface List SwiftUI

**Exercice 3 : Galerie web**
Améliorer le WebView avec :
...
2. Qu'est-ce qu'un Optional en Swift ?
3. Quelle est la différence entre struct et class ?
4. Qu'est-ce que MVVM ?
5. Comment affiche-t-on du HTML dans iOS ?

**Réponses sur la prochaine slide**

---

## Quiz - Réponses

1. **let vs var** : `let` = constante (immutable), `var` = variable (mutable)

2. **Optional** : Type pouvant contenir une valeur ou `nil`, garantit la sécurité

3. **Struct vs Class** : struct = type valeur (copie), class = type référence (partagé)

4. **MVVM** : Model-View-ViewModel, architecture séparant données, présentation et UI

5. **HTML dans iOS** : Avec `WKWebView` (framework WebKit)

---

## Plan pour demain

**Jour 2 : Interface utilisateur avancée**

- SwiftUI approfondi
- Layouts complexes
- Animations et transitions
- Gestion d'état avancée
- TP : Application avec plusieurs écrans
...
- Terminer le TP si pas fini
- Expérimenter avec le code
- Lire la documentation Swift
